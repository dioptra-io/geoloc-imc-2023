...
from default import LOG_PATH, RIPE_CREDENTIALS, ANCHORS_FILE, TARGET_ANCHOR_VP
...
if __name__ == "__main__":
    ...
    measurement_config = {
        ...
        "is_dry_run": dry_run,
        "description": "measurement towards anchors with anchors as vps",
        "type": "target",
        "af": 4,
        "targets": targets,
        "vps": vps,
    ...
    try:
        with open(TARGET_ANCHOR_VP, "rb") as f:
