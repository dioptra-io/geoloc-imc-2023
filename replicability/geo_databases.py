...
from datasets.maxmind.tree import load_radix_tree
from replicability.globals import *
from geohelp.helpers import haversine
from plot_utils.plot import plot_save, plot_multiple_cdf, homogenize_legend
...
def plot_results():
    ...
    Ys = [error_threshold_cdfs_p_to_a[0], list(maxmind_error.values()), list(ip_info_error.values())]
