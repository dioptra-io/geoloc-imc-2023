...
from utils.measurement_utils import get_from_atlas
...
def generate_iris_probing_file(
    raw_atlas_probe_file: Path = Path(
        ".") / "../datasets/raw_probe_atlas.pickle",
...
def iris_probing(
    ...
    measurement_uuid = iris_prober.ping()
...
def validate_atlas_probing(
    responsive_probe_atlas_file=Path(
        ".") / "../datasets/responsive_probe_atlas.pickle",
