...
from utils.common import compute_rtts_per_dst_src, compute_geo_info, compute_error
...
def evaluate():
    ...
    is_compute_accuracy_vs_number_of_vps_anchors = False
    # Fig.2 and 3 of the millions paper
    is_compute_accuracy_vs_number_of_vps_probes = False
    ...
    is_compute_vp_selection_algorithm_anchors = False
    # Fig.5 of the millions paper.
    is_compute_vp_selection_algorithm_probes = True
    ...
    if is_compute:
        ...
        if is_compute_accuracy_vs_number_of_vps_anchors:
            ...
            rtt_per_srcs_dst = compute_rtts_per_dst_src(
                ANCHORS_MESHED_PING_TABLE, filter, threshold=50)
            available_vps = [
                vp for vp in rtt_per_srcs_dst.keys() if vp in vp_coordinates_per_ip]
        ...
        if is_compute_fixed_set:
            ...
            dump_json(min_rtt_per_target_one_per_city,
                      fixed_set_probes_one_per_city_file)
            dump_json(min_rtt_per_target_one_per_city_asn,
